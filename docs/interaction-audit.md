...
| Destination symlinks could redirect writes outside the intended folder. | Symlinks in the selected Root or Destination parent path are rejected. Entries inside a Destination are copied or unlinked as links without following their targets. |
